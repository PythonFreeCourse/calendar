...
from app.database.models import Event, OAuthCredentials, User, UserEvent
...
def get_credentials_from_consent_screen(
    user: User,
    session: SessionLocal = Depends(get_db),
) -> Credentials:
    credentials = None

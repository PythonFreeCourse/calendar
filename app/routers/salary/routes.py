...
async def create_settings(
    ...
    if form:
        ...
        return RedirectResponse(
            router.url_path_for("view_salary", category_id=str(category_id)),
        )
...
async def pick_settings(
    ...
    if form:
        ...
        return RedirectResponse(
            router.url_path_for("edit_settings", category_id=category),
        )
...
async def pick_category(
    ...
    if form:
        category = form["category_id"]
        return RedirectResponse(
            router.url_path_for("view_salary", category_id=category),
        )
...
async def view_salary(
    ...
    try:  # try block prevents crashing upon redirection to the page.
        ...
        salary = utils.calc_salary(
            ...
            deduction=int(form["deduction"]),
            bonus=int(form["bonus"]),
        )

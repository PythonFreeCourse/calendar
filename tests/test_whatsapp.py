...
def test_whatsapp_send():
    ...
    assert whatsapp.make_link(phone_number, message) == {"link": \
        "https://api.whatsapp.com/send?phone=972536106106&text=Event+or+a+"\
...
def test_wrong_phone_number():
    ...
    assert whatsapp.make_link(phone_number, message) == {"link": \
        "https://api.whatsapp.com/send?phone=999999&text=Wrong+phone+"\
        "number%3F"}
...
def test_no_message():
    ...
    message = ''
    assert whatsapp.make_link(phone_number, message) == {"link": \
        "https://api.whatsapp.com/send?phone=972536106106&text="}
...
def test_no_number():
    ...
    assert whatsapp.make_link(phone_number, message) == {"link": \
        "https://api.whatsapp.com/send?phone=&text=Which+phone+number%3F"}

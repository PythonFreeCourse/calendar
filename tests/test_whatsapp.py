...
def test_whatsapp_send():
    ...
    assert whatsapp.make_link(phone_number, message) == 'https://'\
        'api.whatsapp.com/send?phone=972536106106&text=Event+or+a+joke+'\
        'or+the+schedule+of+one+day'
...
def test_wrong_phone_number():
    ...
    assert whatsapp.make_link(phone_number, message) == 'https://'\
        'api.whatsapp.com/send?phone=999999&text=Wrong+phone+number%3F'
...
def test_no_number():
    ...
    assert whatsapp.make_link(phone_number, message) == 'https://'\
        'api.whatsapp.com/send?phone=&text=Which+phone+number%3F'

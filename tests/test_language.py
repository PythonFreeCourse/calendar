...
class TestLanguage:
    ...
    @pytest.mark.parametrize("language_code, translation, is_valid",
                             LANGUAGE_TESTS)
    def test_get_translations_dicts_return_all_supported_languages(
    ...
    @pytest.mark.parametrize("language_code, translation, is_valid",
                             LANGUAGE_TESTS)
    def test_get_translations_dicts_valid_translations(language_code,
                                                       translation, is_valid):
        if is_valid:
            assert languages.get_translations_dicts()[language_code][
                       "test_word"] == translation

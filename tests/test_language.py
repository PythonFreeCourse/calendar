...
class TestLanguage:
    ...
    def test_gettext_python(language_code, translation, is_valid):
        ...
        assert (is_valid and gettext_translation == translation) or (
            not is_valid and gettext_translation == translation
        )
    ...
    def test_gettext_html(language_code, translation, is_valid):
        ...
        assert (is_valid and translation in text) or (
            not is_valid and translation in text
        )

...
class TestAgenda:
    ...
    @staticmethod
    def test_agenda_page_no_arguments_when_no_today_events(client, session):
    ...
    def test_agenda_page_no_arguments_when_today_events_exist(
            self, client, session, sender, today_event,
    ...
    def test_agenda_per_7_days(
            client, session, sender, today_event,
            today_event_2, yesterday_event, next_week_event,
            next_month_event, old_event
    ):
    ...
    def test_agenda_start_bigger_than_end(self, client):

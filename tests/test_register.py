...
REGISTER_FORM_VALIDATORS = [
    ...
    (
        ...
        "example@mail.com",
        "description",
        b"Confirm_password field is required",
    ),
    (
        "admin",
        "admin_user",
...
UNIQUE_FIELDS_ARE_TAKEN = [
    (
        ...
        "password",
        "password",
        "example_new@mail.com",
        "description",
        b"That username is already taken",
    ),
    (
        "admin_new",
        "admin_user",

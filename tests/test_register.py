...
def test_register_form_validators(client, username, full_name, password,
    confirm_password, email, description, expected_response):
...
'''
@pytest.mark.parametrize("username, full_name, password, confirm_password, 
+ "email, description, expected_response", UNIQUE_FIELDS_ARE_TAKEN)
def test_register_form_validators(session, client, username, full_name, password, confirm_password,

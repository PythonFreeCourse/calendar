...
def test_weekly_tasks_check_inputs(
    weekly_task_time
):
    ok = check_inputs(
        days="",
...
def test_weekly_tasks_generate_tasks(
    user, session, weekly_task
):
    weekly_task.owner_id = user.id
    created = create_weekly_task(

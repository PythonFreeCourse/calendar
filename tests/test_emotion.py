...
@pytest.mark.parametrize(
    "dominant_emotion, significance, result",
    emotion_significance_tests,
)
def test_is_emotion_above_significance(dominant_emotion, significance, result):
    if significance is None:
        ...
        assert (
            is_emotion_above_significance(dominant_emotion, significance)
            == result
        )
...
@pytest.mark.parametrize(
    "title, start, end, all_day, owner_id, content, " + "location, result",
    create_event_tests,
)
